      ...
      <div className="portaria-content">
        ...
        <section className="quick-actions-portaria">
          ...
          <div className="actions-row">
            <button className="action-btn-portaria btn-primary">
              ➕ Registrar Visitante
            </button>
            <button className="action-btn-portaria btn-success">
              📷 Capturar Foto
            </button>
            <button className="action-btn-portaria btn-warning">
              📦 Nova Correspondência
            </button>
            <button className="action-btn-portaria btn-info">
              🚗 Entrada Veículo
            </button>
          </div>
        </section>
